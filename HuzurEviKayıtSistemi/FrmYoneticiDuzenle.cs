...
namespace HuzurEviKayıtSistemi
{
    public partial class FrmYoneticiDuzenle : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'huzureviOtomasyonuDataSet5.Admin' table. You can move, or remove it, as needed.
            this.adminTableAdapter.Fill(this.huzureviOtomasyonuDataSet5.Admin);
        }
