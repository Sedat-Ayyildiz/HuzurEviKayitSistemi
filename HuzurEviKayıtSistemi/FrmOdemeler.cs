...
namespace HuzurEviKayıtSistemi
{
    public partial class FrmOdemeler : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'huzureviOtomasyonuDataSet2.Borclar' table. You can move, or remove it, as needed.
            this.borclarTableAdapter.Fill(this.huzureviOtomasyonuDataSet2.Borclar);
        }
        ...
        private void BtnOdemeAl_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("update Borclar set YasliKalanBorc=@p1 where Yasliid=@p2",bgl.baglanti());
            komut.Parameters.AddWithValue("@p2",TxtYasliid.Text);
            ...
            //Kasa Tablosuna Ekleme Yapma Kısmı
