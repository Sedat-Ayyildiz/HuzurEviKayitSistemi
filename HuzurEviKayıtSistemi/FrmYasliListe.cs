...
{
    public partial class FrmYasliListe : Form
    {
        public FrmYasliListe()
        {
            InitializeComponent();
        }

        private void FrmYasliListe_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'huzureviOtomasyonuDataSet3.Yasli' table. You can move, or remove it, as needed.
            this.yasliTableAdapter.Fill(this.huzureviOtomasyonuDataSet3.Yasli);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FrmYasliDuzenle fr = new FrmYasliDuzenle();
            ...
            fr.sgkno = dataGridView1.Rows[secilen].Cells[7].Value.ToString();
